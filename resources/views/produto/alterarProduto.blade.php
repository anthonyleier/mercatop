                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('alterar_produto', ["id" => $produto->id]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nome" type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" required autocomplete="nome" value="{{$produto->nome}}" autofocus />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantidade" type="number" class="form-control @error('quantidade') is-invalid @enderror" name="quantidade" required autocomplete="quantidade" value="{{$produto->quantidade}}" autofocus />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="valor" type="number" step="0.01" class="form-control @error('valor') is-invalid @enderror" name="valor" required autocomplete="valor" value="{{$produto->valor}}" autofocus />
